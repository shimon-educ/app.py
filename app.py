        ...
        if show_step_2:
            ...
            if user_asymp and user_horiz:
                ...
                try:
                    ...
                    # בדיקת אופקית (תומך גם ב-"אין")
                    if user_horiz.lower() == "אין":
                        correct_h = not true_horiz_lim.is_finite
                    else:
                        correct_h = np.isclose(float(user_horiz), float(true_horiz_lim))
                    ...
                    if correct_v and correct_h:
                        ...
                        if not correct_v:
                            ...
                            with st.expander("🔍 רמז לאסימפטוטה אנכית"):
                                ...
                                st.write("אלו בדיוק המקומות בהם הגרף ייעצר וייצור קו אנכי.")
